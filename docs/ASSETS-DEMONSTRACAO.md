...
A sequência operacional canônica está no [Plano de execução](PLANO-DE-EXECUCAO.md) e no [Estado de validação](ESTADO-VALIDACAO.md). Em 26/08/2026, a secret exposta já havia sido substituída, o banco remoto tinha sido reconstruído, o lifecycle hospedado estava aprovado e o Worker/Cron Cloudflare estava ativo. O gate imediato é concluir retry/alerta remoto e os casos adversários restantes de Auth.
