...
Backlog oficial do projeto, reconciliado com o código e as evidências de execução em **26/08/2026**. A evidência temporal detalhada está em [Estado de validação](docs/ESTADO-VALIDACAO.md).
